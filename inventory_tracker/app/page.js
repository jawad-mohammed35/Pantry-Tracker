  ...
  return (
    ...
    >
      <div className="inline-block bg-gradient-to-r z-10 max-w-5xl w-full items-center justify-between font-mono text-sm from-green-500 to-purple-500 text-white p-2 rounded-lg">
        <h1 className="text-4xl p-4 text-center">My Pantry</h1>
        <p className="text-center text-lg text-white">
          Keep track of your pantry. Add, edit, delete, and
          search for items as needed, and see your total value. Devloped by Jawad Mohammed
        </p>
